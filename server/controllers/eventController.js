...
eventController.createEvent = (req, res, next) => {
    ...
    const inputValues = [req.body.title, req.body.date, req.body.start_time, req.body.end_time, req.body.activity_type, req.body.num_participants, req.body.zip, req.body.location, req.body.created_by_id];
    //create query string
